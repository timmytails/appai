...
export default function CompleteProfile() {
    ...
    return (
        <div className='profile-completion-page min-h-screen bg-[var(--tt-canvas)] px-4 py-12 text-[var(--tt-ink)] sm:px-6 lg:px-8'>
            <div className='mx-auto max-w-2xl'>

                {/* Brand title */}
                <div className='mb-6 flex items-center gap-3'>
                    <img src='/logo.png' alt='TimmyTails logo' className='h-9 w-9 rounded-full object-cover shadow-xs ring-1 ring-[var(--tt-border)] bg-white' />
                    <span className='font-serif text-2xl font-bold tracking-tight text-[var(--tt-ink)]'>
                        TimmyTails
                    </span>
                </div>

                <div className='rounded-sm border border-[var(--tt-border)] bg-white p-6 sm:p-10'>
                    {/* Step indicator */}
                    <div className='mb-6 flex items-center gap-3'>
                        <span className='inline-flex items-center gap-1.5 rounded-md bg-[var(--tt-brand)]/10 px-3 py-1 text-xs font-bold text-[var(--tt-brand)]'>
                            Step 2 of 2
                        </span>
                        <span className='h-px flex-1 bg-[var(--tt-canvas)]' />
                    </div>
                    ...
                    <button
                        ...
                        className='mt-5 w-full text-xs font-bold text-[var(--tt-ink-soft)] hover:text-[var(--tt-ink)]'
                    >
