...
export default function AdminCancelModal({
    ...
    return (
        <div
            className='fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4 bg-[var(--tt-ink)]/60 backdrop-blur-xs animate-in fade-in duration-150 overflow-y-auto'
                ...
                <form onSubmit={handleSubmit} className='space-y-4'>
                    ...
                    <div className='flex flex-col-reverse sm:grid sm:grid-cols-2 gap-2.5 pt-3 border-t border-[var(--tt-border)]'>
                        <button
                            ...
                            onClick={onClose}
                            disabled={loading}
                            className='w-full border border-[var(--tt-border)] bg-white px-3 py-2.5 text-xs font-bold text-[var(--tt-ink-soft)] text-center transition hover:bg-[var(--tt-canvas)] disabled:opacity-50'
                        >
                            Keep Booking
                        </button>
                        <button
